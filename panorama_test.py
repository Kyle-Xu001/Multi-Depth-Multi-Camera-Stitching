...
if __name__ == '__main__':
    ...
    # ROIs1 = cv.selectROIs("Area Selection", img_stitch)
    # ROIs2 = cv.selectROIs("Area Selection", img5)
    ...
    # stitches = Stitch(img_stitch, img5)
    ...
    #     img_stitch, kps1, img5, kps2, matches_inliers, None, **draw_params)
    ...
    # '''Stitch the Images'''
    # img_stitch_ = ImageStitch.simpleStitch(img_stitch, img5, homo_mat)
